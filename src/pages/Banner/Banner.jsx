    ...
    return (
        <div className='text-center pt-8 md:pt-16'>
            <div className='space-y-5'>
                ...
                <p className='text-gray-500'>At Hero App Store we craft innovative apps designed to make everyday life simpler, smarter, and more exciting. <br className="hidden sm:block" /> Our goal is to turn your ideas into digital experiences that truly make an impact.</p>
                <div className='flex gap-2 md:gap-4 justify-center pt-4'>
                    <Link to="https://play.google.com/store/games?hl=en">
                        <div className='flex gap-2 items-center border-1 border-gray-300 px-3 py-2 bg-white shadow-xs rounded-sm hover:bg-violet-600 hover:text-white transition-all duration-300'>
                            <img src={googleStore} alt="Google Play Store" className='w-[30px] h-[30px]' />
                            <p className='font-semibold text-gray-600 hover:text-white'>Google Play Store</p>
                        </div>
                    </Link>
                    <Link to="https://www.apple.com/app-store/">
                        <div className='flex gap-2 items-center border-1 border-gray-300 px-4 py-2 rounded-sm bg-white shadow-xs hover:bg-violet-600 hover:text-white transition-all duration-300'>
                            <img src={appStore} alt="App Store" className='w-[30px] h-[30px]' />
                            <p className='font-semibold text-gray-600 hover:text-white'>App Store</p>
                        </div>
                    </Link>
                </div>
            </div>
            ...
            <div className='py-8 md:py-14 space-y-4 md:space-y-6 bg-gradient-to-r from-violet-700  to-violet-500'>
                ...
                <div className='flex justify-center px-5 md:px-0 gap-4 md:gap-32'>
                    <div className='text-center space-y-2 md:space-y-3'>
                        ...
                        <h5 className='text-[10px] text-white'>21% More Than Last Month</h5>
                    </div>
                    <div className='text-center space-y-2 md:space-y-3'>
                        ...
                        <h5 className='text-[10px] text-white'>46% More Than Last Month</h5>
                    </div>
                    <div className='text-center space-y-2 md:space-y-3'>
